...
export const ENTRIES_FALLBACK: Entry[] = [
  ...
  },
  {
    ...
    tech: ["ASP.NET Core", "Angular", "SQL Server", "PostgreSQL", "Firebase FCM"],
    features: [
  ...
  },
  {
    ...
    tech: [".NET 8", "Angular", "SignalR", "SQL Server", "PostgreSQL"],
    features: [
  ...
  },
  {
    ...
    tech: [".NET 8", "React 19", "TypeScript", "SQL Server", "Firebase FCM", "AWS S3"],
    features: [
  ...
  },
  {
    ...
    tech: ["React 19", "TypeScript", "Tailwind CSS", "Cloudflare Workers", "R2"],
    features: [
